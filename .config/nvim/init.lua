...
do
  ...
  -- NOTE: Liam removing guess-indent, not sure why i would want it
  ...
  -- NOTE: Liam might remove this it's weirdly slow
...
do
  ...
  vim.keymap.set({ 'n', 'v' }, '<space>f', function() require('conform').format { async = true } end, { desc = '[F]ormat buffer' })
end
